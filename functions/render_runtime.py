...
import render_local_falcon_metrics as local_falcon_metrics
...
def _parse_local_falcon_number(value: Any) -> float | None:
    return local_falcon_metrics.parse_local_falcon_number(value)
...
def _normalize_local_falcon_rank(value: Any) -> int | None:
    return local_falcon_metrics.normalize_local_falcon_rank(value)
...
def _average_local_falcon_metric(items: list[dict[str, Any]], key: str) -> float | None:
    return local_falcon_metrics.average_local_falcon_metric(items, key)


def _normalize_local_falcon_date_label(value: Any) -> str:
    return local_falcon_metrics.normalize_local_falcon_date_label(value)


def _summarize_local_falcon_scan_detail(detail: dict[str, Any] | None) -> dict[str, Any]:
    return local_falcon_metrics.summarize_local_falcon_scan_detail(detail)
...
def _normalize_local_falcon_trends(
    ...
    return local_falcon_metrics.normalize_local_falcon_trends(reports, scan_details)
